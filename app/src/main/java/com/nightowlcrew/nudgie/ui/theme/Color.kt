...
// Primary Brand Colors (Used for Default Theme)
val BrandGold = Color(0xFFFFD700)      // Primary "Win" color
val HeartRed = Color(0xFFFF8A8A)       // Happiness stat color
val ElectricYellow = Color(0xFFFFEB3B) // Energy stat color
val LevelUpBlue = Color(0xFF29B6F6)    // Level stat color
...
val cpStatLevel = cpNeonCyan
val cpStatSuccess = Color(0xFF00FF00)  // Neon Green
...
val spStatLevel = Color(0xFF4A7C59)     // Oxidized Copper
val spStatSuccess = Color(0xFF6B8E23)   // Clockwork Olive

// Goth Theme Colors
val gothAbyss = Color(0xFF050505)      // Pitch black background
val gothObsidian = Color(0xFF16161A)   // Very dark gray for surfaces
