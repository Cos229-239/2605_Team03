...
fun WalkSetupDialog(
    ...
    onStartWalk: (WalkTrackingMode) -> Unit
) {
    Dialog(onDismissRequest = onDismissRequest) {
        Surface(
            ...
            Column(
                ...
                WalkOptionButton("Track Distance (GPS)") { onStartWalk(WalkTrackingMode.DISTANCE) }
                WalkOptionButton("Step Goal (Pedometer)") { onStartWalk(WalkTrackingMode.STEPS) }
                WalkOptionButton("Both!") { onStartWalk(WalkTrackingMode.BOTH) }
